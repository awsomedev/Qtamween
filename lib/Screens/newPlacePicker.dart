...
class PlacePickerNew extends StatefulWidget {
  ...
  PlacePickerNew(this.apiKey, {this.displayLocation});

  @override
  State<StatefulWidget> createState() => PlacePickerNewState();
}

/// Place picker state
class PlacePickerNewState extends State<PlacePickerNew> {
          ...
          Align(
              ...
              child: InkWell(
                onTap: () async {
                  ...
                  clearOverlay();
                  moveToLocation(LatLng(pos.latitude, pos.longitude));
                },
                child: Container(
                  height: 40,
                  width: 40,
